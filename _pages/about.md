...
My research lies at the nexus of theory, computing, and data, where I developed state-space framework to infer latent physiological conditions from mutimodal data. Due to the complex human anatomy and physiology, inferring underlying physiological condition encounters challenges such as inter-individual and intra-individual variability and sparsity of data. My research aims to address these challenges by employing personalized, automated, and system-theoretic toolboxes that can infer the underlying physiological condition and facilitate the diagnosis and treatment.
