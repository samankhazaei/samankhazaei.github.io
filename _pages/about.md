...
I am a postdoctoral fellow at [Windreich Department of Artificial Intelligence and Human Health at Icahn School of Medicine at Mount Sinai](https://icahn.mssm.edu/about/artificial-intelligence), specializing in AI-driven modeling and tracking of hidden health and brain states. I have obtained my PhD candidate in the Biomedical Engineering program at [New York University (NYU) Tandon School of Engineering](https://engineering.nyu.edu/student/saman-khazaei), where I was advised by [Dr. Rose T. Faghih](https://engineering.nyu.edu/faculty/rose-faghih) at the [Computational Medicine Lab (CML)](https://wp.nyu.edu/cml/).

My research lies at the nexus of theory, computing, and data, where I developed Bayesian state-space models and decoders to infer latent brain and health states from mutimodal data. The main objective of my research is to model and decode the hidden brain and health state of interest from the available source of information. Due to the complex anatomy and physiology of the human brain and body, decoding these hidden states encounters challenges such as inter-individual and intra-individual variability and sparsity of training data. My research aims to address these challenges by employing personalized, automated, and system-theoretic toolboxes that can decode the underlying states and facilitate the intervention design process in a closed-loop architecture.
